...
const FALLBACK_IMAGE =
  "https://picsum.photos/seed/neela-category/500/600";
  ...
  useEffect(() => {
    ...
    const loadCategories = async () => {
      try {
        ...
        console.log("Featured Categories API:", data);
        ...
        <div className="grid grid-cols-2 gap-4 sm:gap-6 lg:grid-cols-4">
          {loading ? (
            Array.from({ length: 8 }).map((_, i) => (
              <div
                key={i}
                className="aspect-[4/5] animate-pulse rounded-lg bg-charcoal/5"
              />
            ))
          ) : (
                ...
                >
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-4">
                    ...
                    <p className="text-xs tracking-widest text-cream/70">
                      ...
                      PIECE{category.product_count === 1 ? "" : "S"}
                    </p>
